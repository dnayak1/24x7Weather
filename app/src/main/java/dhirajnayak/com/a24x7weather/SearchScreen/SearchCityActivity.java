 ...
 * Search city activity to display the cities
 */
...
public class SearchCityActivity extends AppCompatActivity implements ISearchCityView, CityAdapter.ICityListener, CityRepository.INotifyAdapter {
    ...
    //Creating search view on the toolbar
    @Override
    ...
    //populating recycler view with the city search results
    @Override
    ...
    //saving the city in shared preferences and navigating to next activity/module
    @Override
    public void setSelectedCity(City selectedCity) {

    }

    //notify the adapter with new search results
    @Override
